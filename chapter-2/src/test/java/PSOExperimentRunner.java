 ...
 * 
 * 功能：
 * 1. 批量运行J10、J20、J50、J100算例
 * 2. 每个算例运行10次
 * 3. 多线程并行加速
 * 4. 输出详细结果（迭代曲线、甘特图、打印布局图、实验报告）
 * 5. 生成汇总统计表
 * 6. 与混合GA算法进行对比
 */
public class PSOExperimentRunner {
    ...
    private static final String RESULT_BASE_DIR = "C:\\Users\\Zhang Hailong\\Desktop\\毕设相关\\毕设程序\\Article\\src\\main\\resources\\result\\对比试验\\PSO\\";
    ...
    private static RunResult runSingleExperiment(String instancePath, String instanceName, 
                                                 int runNo, PSOParameters params) throws Exception {
        // 解析算例
        ...
        writer.writeExperimentInfo("PSO粒子群算法", runNo, params.toString());
    ...
    private static Map<String, Object> runInstanceExperiments(InstanceInfo instance, 
                                                              int threadCount,
                                                              PSOParameters params) throws Exception {
        System.out.println("\n" + repeatString("=", 100));
    ...
    private static void generateSummaryReport(List<Map<String, Object>> allResults) throws Exception {
        ...
        writer.println("================================================================================");
        writer.println("                     PSO算法 - 综合实验汇总统计表");
        writer.println("================================================================================");
        ...
        for (Map<String, Object> result : allResults) {
            String name = (String) result.get("instanceName");
            String category = "";
            if (name.startsWith("J100")) category = "J100";
            else if (name.startsWith("J50")) category = "J50";
            else if (name.startsWith("J20")) category = "J20";
            else if (name.startsWith("J10")) category = "J10";
    ...
    public static void main(String[] args) {
        ...
        System.out.println(repeatString("=", 100));
        System.out.println("                     PSO算法 - 综合对比实验");
        System.out.println(repeatString("=", 100));
