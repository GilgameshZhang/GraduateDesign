 ...
 * 5. 生成汇总统计表
 */
public class ComprehensiveExperimentRunner {
    ...
    private static final String RESULT_BASE_DIR = "C:\\Users\\Zhang Hailong\\Desktop\\毕设相关\\毕设程序\\Article\\src\\main\\resources\\result\\对比试验\\混合GA\\";
    ...
    private static RunResult runSingleExperiment(String instancePath, String instanceName, 
        ...
        writer.writeExperimentInfo("混合GA算法", runNo, params);
    ...
    private static void generateSummaryReport(List<Map<String, Object>> allResults) throws Exception {
        ...
        writer.println("================================================================================");
        writer.println("                     混合GA算法 - 综合实验汇总统计表");
        writer.println("================================================================================");
    ...
    public static void main(String[] args) {
        ...
        System.out.println(repeatString("=", 100));
        System.out.println("                     混合GA算法 - 综合对比实验");
        System.out.println(repeatString("=", 100));
